...
impl Expression {
    ...
    fn new_binary(operation: ArithmeticOperation,left: Expression,right: Expression) -> Self {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Expression::Binary { operation , left , right } => match operation {
                ...
                ArithmeticOperation::Mal => write!(f, "{left}({right})"),
                ArithmeticOperation::Durch => write!(f,"({left})/({right})"),
            },
        }
    }
}
...
mod tests {
    ...
    fn test_display_for_nested_expression() {
        ...
        let inner_expression = Expression::Term(inner_term);
    ...
    fn test_display_for_plus_expression() {
        ...
        let expression = Expression::Binary {
            ...
            left: Box::new(term1.into()),
            right: Box::new(term2.into()),
        };
    ...
    fn test_display_for_mal_expression() {
        ...
        let expression = Expression::Binary {
            operation: ArithmeticOperation::Mal,
            left: Box::new(term1.into()),
            right: Box::new(term2.into()),
        };
    ...
    fn test_display_for_durch_expression() {
        ...
        let expression = Expression::Binary {
            operation: ArithmeticOperation::Durch,
            left: Box::new(term1.into()),
            right: Box::new(term2.into()),
        };
